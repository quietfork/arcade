...
なので作った。[Arcade](https://github.com/quietfork/arcade) — Claude Code のためのデスクトップランチャー。MIT、Windows + macOS で動く、バイナリは約 25 MB。
...
- **リポジトリ**: [github.com/quietfork/arcade](https://github.com/quietfork/arcade)
- **ライセンス**: MIT
