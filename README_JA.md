...
1. [Releases](https://github.com/quietfork/arcade/releases/latest) から `Arcade-Setup-vX.Y.Z.exe` をダウンロード。
...
1. [Releases](https://github.com/quietfork/arcade/releases/latest) から `Arcade-vX.Y.Z-universal.dmg` をダウンロード。
